defmodule QwatchWeb.Coherence.ViewHelpers do
  @moduledoc """
  ...
  For example, to generate links in your layout template use:
      QwatchWeb.Coherence.ViewHelps.coherence_links/3
  ...
  @seperator {:safe, "&nbsp; | &nbsp;"}
  @helpers QwatchWeb.Router.Helpers
  ...
  * :register - customize the register link text (#{@register_link_text})
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(QwatchWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(QwatchWeb.Gettext, "errors", msg, opts)
    end
  end
