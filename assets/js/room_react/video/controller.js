  ...
  render(){
    ...
    <div className="controller">
      ...
      <div className="controller__buttons">
        ...
        {/* <Tippy
          placement="top"
          content={this.props.live ?  "Desync from server" : "Sync with server"}>
        <button className={liveBtnClassName} onClick={this.props.setLive}>
          <span className="oi" data-glyph="media-record" title="Toggle Live" aria-hidden="true"></span>
        </button>
        </Tippy> */}
        <Tippy
          trigger="click"
        ...
        <div className="controller__status">
          { !this.props.live && !this.props.hasRemote && 
            <span>
              Desynced
              <a href="#" onClick={this.props.setLive}>
                . Synchronize?
              </a>
            </span>
          }
  ...
  render(){
    return (
      <div>
        ...
        <div tyle={{"marginTop": "5px"}}>
          <a class="link-muted" href="/faq" target="_blank">Supported sites</a>
        </div>
      </div>
    )
  }
